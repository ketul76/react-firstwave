const data = {
    ...
    LegalPage: {
        ...
        legalterms1: [
            {class:"process-list",imgLink: "./legal-terms-imgs/legal-process/privacy.svg",title:"Privacy Statement",text1: "About this Privacy Statement, Opmantek is",text2: "committed to maintaining the security of…",downloadLink: "Download PDF"},
        ...
        legalterms2: [
            ...
            {class:"process-list",imgLink: "./legal-terms-imgs/legal-process/licence.svg",title:"Licensing",text1: "The purpose of this licensing page is to list the",text2: "products and licenses included in Opmantek ...",downloadLink: "Download PDF"},
    ...
    financialPage: {
        ...
        queAns: [
            {class: "que-ans",text: "What is the ASX ticker code for FirstWave Cloud Technology Limited?"},
            {class: "que-ans",text: "What is the ASX ticker code for FirstWave Cloud Technology Limited?"},
            {class: "que-ans",text: "What is the ASX ticker code for FirstWave Cloud Technology Limited?"},
            {class: "que-ans",text: "What is the ASX ticker code for FirstWave Cloud Technology Limited?"},
            {class: "que-ans",text: "What is the ASX ticker code for FirstWave Cloud Technology Limited?"},
